...
set CLASSPATH=%APP_HOME%\lib\Distiller-1.0-SNAPSHOT-all.jar

@rem Execute Distiller
"%JAVA_EXE%" %DEFAULT_JVM_OPTS% %JAVA_OPTS% %DISTILLER_OPTS%  -jar "%CLASSPATH%" %CMD_LINE_ARGS%
...
if  not "" == "%DISTILLER_EXIT_CONSOLE%" exit 1
exit /b 1
